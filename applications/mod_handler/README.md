...
- **CAN 远程配参** — Host 通过 CAN 帧 0x105/0x106 远程设置/查询 LoRa 网关参数 (prot+mode+spd+ch+gwid)
...
Host 通过 CAN 帧 0x105 设置或查询 LoRa 网关参数，设备通过 0x106 响应。
...
```
include/
  common.h          -- 全局状态类型 (gloval_params_t, scanner_data_t, CAN_TYPE/LORA_TYPE)
