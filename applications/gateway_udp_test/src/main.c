...
/* 网络链路状态: IF_UP 置 true, IF_DOWN 置 false. gut_udp_send 据此决定是否转发. */
volatile bool gut_net_link_up;
...
/* IF_UP/IF_DOWN: carrier 状态变化 → 唤醒 main + 启动 DHCP + 维护 gut_net_link_up. */
