 ...
 *
 * gw_sim application common definitions
 * (移植自 gateway, 裁剪 persist/settings/rf24_shell 相关声明)
 */
...
/* ================================================================
 * 帧 ID (与 gateway/mod_handler 保持一致; nRF24/UDP 帧协议的逻辑标识符,
...
/* rf24_stub.c (native_sim 无射频, stub 实现) */
